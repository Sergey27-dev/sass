...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$mail->setText(($this->request->post['enquiry']." | Данное сообщение отправлено со страницы Контакты, клиентом ".$this->request->post['name'].", почта клиента: ".$this->request->post['email']));
			$mail->send();
      ...
      if ($this->config->get('mlseo_enabled')) {
		...
		$data['mails'] = $this->config->get('config_email');
