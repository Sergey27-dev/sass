...
?>
    <style type="text/css">
        ...
        <?php if (isset($settings['style']['resp_show_btn_color']['val'])) : ?> background: <?php echo $settings['style']['resp_show_btn_color']['val']; ?>;
        <?php endif; ?>
        }

        .bf-layout-id-<?php echo $layout_id;?> .bf-btn-reset {
        <?php if (isset($settings['style']['resp_reset_btn_color']['val'])) : ?> background: <?php echo $settings['style']['resp_reset_btn_color']['val']; ?>;
        <?php endif; ?>
        }

        .bf-layout-id-<?php echo $layout_id;?> .bf-attr-header {
        <?php echo isset($settings['style']['block_header_background']['val'])  ? 'background: '.$settings['style']['block_header_background']['val'].';':''; ?><?php echo isset($settings['style']['block_header_text']['val']) ? 'color: '.$settings['style']['block_header_text']['val'].';':''; ?>
        }

        .bf-layout-id-<?php echo $layout_id;?> .bf-count {
        <?php echo isset($settings['style']['product_quantity_background']['val']) ? 'background: '.$settings['style']['product_quantity_background']['val'].';':''; ?><?php echo isset($settings['style']['product_quantity_text']['val']) ? 'color: '.$settings['style']['product_quantity_text']['val'].';':''; ?>
        }
        ...
        <?php echo isset($settings['style']['price_slider_background']['val']) ? 'background: '.$settings['style']['price_slider_background']['val'].';':''; ?><?php echo isset($settings['style']['price_slider_border']['val']) ? 'border:1px solid '.$settings['style']['price_slider_border']['val'].';':''; ?>
        }

        .bf-layout-id-<?php echo $layout_id;?> .ui-state-default {
        <?php echo isset($settings['style']['price_slider_handle_background']['val']) ? 'background: '.$settings['style']['price_slider_handle_background']['val'].';':''; ?><?php echo isset($settings['style']['price_slider_handle_border']['val']) ? 'border:1px solid '.$settings['style']['price_slider_handle_border']['val'].';':''; ?>
        }

        .bf-layout-id-<?php echo $layout_id;?> .bf-attr-group-header {
        <?php echo isset($settings['style']['group_block_header_background']['val']) ? 'background: '.$settings['style']['group_block_header_background']['val'].';':''; ?><?php echo isset($settings['style']['group_block_header_text']['val']) ? 'color: '.$settings['style']['group_block_header_text']['val'].';':''; ?>
        }
...
<?php if (count($filters)) : ?>
    <div class="btn btn-primary mobile_filter"  >
  ...
  <div  id="collapseExample">
    <div class="bf-panel-wrapper<?php if ($isResponsive) : ?> bf-responsive<?php endif; ?> <?php echo $responsivePos; ?> bf-layout-id-<?php echo $layout_id; ?>">
        ...
        <div class="box bf-check-position <?php if ($isHorizontal) : ?>bf-horizontal<?php endif; ?>">
            <!--        <div class="box-heading b-module-filteropen">-->
            <?php //echo $lang_block_title; ?><!--<i class="b-filteropen fa fa-chevron-down d-block d-lg-none d-xl-none d-md-none float-right" aria-hidden="true"></i>-->
            <?php //if ($isHorizontal) : ?><!--<a class="bf-toggle-filter-arrow"></a><input type="reset" class="bf-buttonclear" onclick="BrainyFilter.reset();" value="-->
            <?php //echo $reset; ?><!--" />--><?php //endif; ?><!--</div>-->
            <div class="brainyfilter-panel box-content <?php if ($settings['submission']['hide_panel']) : ?>bf-hide-panel<?php endif; ?>">
                <form class="bf-form
                                    ...
                                    <div class="bf-price-container box-content bf-attr-filter">
                                        <?php if (in_array($sliderType, array(1, 3))) : ?>
                                            <div class="bf-cur-symb">
                                                <input type="text" class="bf-range-min" name="bfp_price_min"
                                                       value="<?php echo $lowerlimit; ?>" size="4"/>
                                                <span class="ndash">&#8211;</span>
                                                <!--                                    <span class="bf-cur-symb-left">-->
                                                <?php //echo $currency_symbol; ?><!--</span>-->
                                                <input type="text" class="bf-range-max" name="bfp_price_max"
                                                       value="<?php echo $upperlimit; ?>" size="4"/>
                                            </div>
                                        <?php else : ?>
                                            <input type="hidden" class="bf-range-min" name="bfp_price_min"
                                                   value="<?php echo $lowerlimit; ?>"/>
                                            <input type="hidden" class="bf-range-max" name="bfp_price_max"
                                                   value="<?php echo $upperlimit; ?>"/>
                                        <?php endif; ?>
                                        <div class="bf-price-slider-container <?php if ($sliderType === 2 || $sliderType === 3): ?>bf-slider-with-labels<?php endif; ?>">
                                            <div class="bf-slider-range"
                                                 data-slider-type="<?php echo $sliderType; ?>"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bf-attr-block bf-keywords-filter <?php if ($isHorizontal && isset($filters[$i + 1]) && $filters[$i + 1]['type'] === 'price') : ?>bf-left-half<?php endif; ?>">
                                ...
                                <div class="bf-attr-block-cont">
                                    <div class="bf-search-container bf-attr-filter">
                                        <div>
                                            <input type="text" class="bf-search" name="bfp_search"
                                                   value="<?php echo $bfSearch; ?>"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="bf-attr-block-cont">
                                        ...
                                        <div class="bf-attr-filter bf-attr-<?php echo $groupUID; ?> bf-row">
                                            <div class="bf-cell">
                                                <select name="<?php echo "bfp_{$groupUID}"; ?>">
                                                    <option value=""
                                                            class="bf-default"><?php echo $default_value_select; ?></option>
                                                    <?php foreach ($section['values'] as $cat) : $catId = $cat['id'] ?>
                                                        <?php $isSelected = isset($selected[$groupUID]) && in_array($catId, $selected[$groupUID]); ?>
                                                        <option value="<?php echo $catId; ?>" class="bf-attr-val"
                                                                <?php if ($isSelected) : ?>selected="true"<?php endif; ?>>
                                    ...
                                    <span class="bf-cell bf-c-1">
                                        <input id="bf-attr-<?php echo $groupUID . '_' . $catId . '_' . $layout_id; ?>"
                                               ...
                                               name="<?php echo "bfp_{$groupUID}"; ?><?php if ($section['control'] === 'checkbox') {
                                                   echo "_{$catId}";
                                               } ?>"
                                    ...
                                    <div class="bf-attr-block-cont">
                                                    ...
                                                    <select name="<?php echo "bfp_{$groupUID}"; ?>">
                                                        ...
                                                        <?php foreach ($group['values'] as $value) : ?>
                                                            ...
                                                            <option value="<?php echo $value['id']; ?>"
                                                                    class="bf-attr-val"
                                                                    <?php if ($isSelected) : ?>selected="true"<?php endif; ?>><?php echo $value['name']; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="bf-attr-filter bf-attr-<?php echo $groupUID; ?> bf-row">
                                                <div class="bf-cell">
                                                    <div class="bf-slider-inputs">
                                                        ...
                                                        <input type="hidden" name="bfp_min_<?php echo $groupUID; ?>"
                                                               value="<?php echo $isMinSet ? $selected[$groupUID]['min'] : 'na'; ?>"
                                                               class="bf-attr-min-<?php echo $groupUID; ?>"
                                                               data-min-limit="<?php echo $group['min']['s']; ?>"/>
                                                        <input type="hidden" name="bfp_max_<?php echo $groupUID; ?>"
                                                               value="<?php echo $isMaxSet ? $selected[$groupUID]['max'] : 'na'; ?>"
                                                               class="bf-attr-max-<?php echo $groupUID; ?>"
                                                               data-max-limit="<?php echo $group['max']['s']; ?>"/>
                                                               <span style="display:none" class="kkkkk"><?print_r($group)?></span>
                                                        <?php if ($group['type'] !== 'slider_lbl') : ?>
                                                            ...
                                                            <input type="text" name=""
                                                                   class="bf-slider-text-inp-min bf-slider-input"
                                                                   value="<?php echo $group['values'][0]['n']; ?><?php //echo $minLbl; ?>"
                                                                   placeholder="<?php echo $lang_empty_slider; ?>"/>
                                                            <span class="ndash">&#8211;</span>
                                                            <input type="text" name=""
                                                                   class="bf-slider-text-inp-max bf-slider-input"
                                                                   value="<?php echo $group['values'][count($group['values'])-1]['n']; ?><?php// echo $maxLbl; ?>"
                                                                   placeholder="<?php echo $lang_empty_slider; ?>"/>
                                                        <?php endif; ?>
                                                    </div>
                                                    <div class="bf-slider-container-wrapper <?php if ($sliderType === 2 || $sliderType === 3): ?>bf-slider-with-labels<?php endif; ?>">
                                                        <div class="bf-slider-container"
                                                             data-slider-group="<?php echo $groupUID; ?>"
                                                             data-slider-type="<?php echo $sliderType; ?>"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <span class="bf-cell bf-c-1">
                                            <input id="bf-attr-<?php echo $groupUID . '_' . $valueId . '_' . $layout_id; ?>"
                                                   ...
                                                   name="<?php echo "bfp_{$groupUID}"; ?><?php if ($group['type'] === 'checkbox') {
                                                       echo "_{$valueId}";
                                                   } ?>"
                                                   value="<?php echo $valueId; ?>"
                                                   <?php if (isset($selected[$groupUID]) && in_array($valueId, $selected[$groupUID])) : ?>checked="true"<?php endif; ?> />
                    ...
                    <?php endforeach; ?>
                    <div class="bf-affr-block">
                        <div class="bf-sliding-cont">
                            <div class="bf-sliding bf-expanded">
                                <div class="bf-attr-block-cont">
                                    <div class="bf-attr-filter slider-checkbox">
                                        <span class="bf-cell bf-c-1">
                                            <input type="checkbox" id="saleFilter">
                                        </span>
                                        <span class="bf-cell bf-c-2">
                                            <label class="slider-label" id="saleFilterLabel" for="saleFilter">Распродажа</label>
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <label for="saleFilter"></label>
                    <?php if (!$isHorizontal || $settings['submission']['submit_type'] == 'button') : ?>
                    <div
                            class="bf-buttonclear-box"
                            <?php if ($isHorizontal && $settings['submission']['submit_button_type'] == 'float') : ?>style="display:none;"<?php endif; ?>>
                        <input type="button" value="<?php echo $lang_submit; ?>" class="btn btn-primary bf-buttonsubmit"
                               onclick="BrainyFilter.sendRequest(jQuery(this));BrainyFilter.loadingAnimation();return false;"
                               <?php if ($settings['submission']['submit_button_type'] != 'fix' && $settings['submission']['submit_type'] != 'button')  : ?>style="display:none;" <?php endif; ?> />
                        <?php if (!$isHorizontal) : ?><input type="reset" class="bf-buttonclear"
                                                             onclick="BrainyFilter.reset();return false;"
                                                             value="<?php echo $reset; ?>" /><?php endif; ?>
                        </div><?php endif; ?>
                </form>
            </div>
        </div>
    ...
    <script>
        var bfLang = {
            ...
            empty_list: '<?php echo $lang_empty_list; ?>'
                ...
                <?php if (isset($sefParam)) : ?>
                BrainyFilter.sefParam = '<?php echo $sefParam; ?>';
                BrainyFilter.sefValue = '<?php echo $sefValue; ?>';
               <?php endif; ?>
