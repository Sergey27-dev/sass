...
<style>
    ...
    .bf-disable-enable .bf-yes:before {
        content: '<?php echo $lang->enable_all; ?>';
                ...
                <ul style="display:none;" id="seo-top-menu-item-cont">
                    <li class="seo-menu-item">
                        <div>
                ...
                <script>
                    ;(function($) {
                        $('#bf-adm-main-menu > ul').append($('#seo-top-menu-item-cont li'));
                    })(jQuery);
                </script>
                <style>
                    #bf-adm-main-menu {
                    ...
                    #bf-adm-main-menu .icon.seo {
                        background: url("view/image/brainyfilter/seo-menu-icon.png") no-repeat;
                        background-position: 0 0;
                        width: 30px;
                    }
                    #bf-adm-main-menu li.selected .icon.seo, #bf-adm-main-menu li:hover .icon.seo {
                        background-position: 0 -33px;
                    }
                    #bf-adm-main-menu > ul > li.seo-menu-item {
                        width: 230px;
                        padding: 0;
                    }
                    #bf-adm-main-menu > ul > li.seo-menu-item a {
                        display: block;
                        padding: 7px 10px 10px;
                        overflow: auto;
                        color: inherit;
                    }
                    #bf-adm-main-menu > ul > li.seo-menu-item a:hover {
                        color: #fff;
                    }
                    #bf-adm-main-menu > ul .tab + li.seo-menu-item div a {
                        padding-top: 10px;
                    }
                </style>
