        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="soc_vk_link"><span data-toggle="tooltip" title="<?echo $text_link_soc;?>"><? echo $text_link_vk; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_soc_vk" class="form-control" id="input-soc_vk_link" value="<? echo $config_soc_vk;?>"/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="soc_inst_link"><span data-toggle="tooltip" title="<?echo $text_link_soc;?>"><? echo $text_link_inst;?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_soc_inst" class="form-control" id="input-soc_inst_link" value="<? echo $config_soc_inst;?>"/>
                </div>
              </div>

			<div class="form-group">
                <label class="col-sm-2 control-label" for="yametr"><span data-toggle="tooltip" title="<?echo $text_yametric;?>"><? echo $text_yametric;?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_yametr" class="form-control" id="input-yametr" value="<? echo $config_yametr;?>"/>
                </div>
              </div>

			  <div class="form-group">
                <label class="col-sm-2 control-label" for="yawebm"><span data-toggle="tooltip" title="<?echo $text_yawebm;?>"><? echo $text_yawebm;?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_yawebm" class="form-control" id="input-yawebm" value="<? echo $config_yawebm;?>"/>
                </div>
              </div>

			  <div class="form-group">
                <label class="col-sm-2 control-label" for="googleconsole"><span data-toggle="tooltip" title="<?echo $text_googleconsole;?>"><? echo $text_googleconsole;?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_googleconsole" class="form-control" id="input-googleconsole" value="<? echo $config_googleconsole;?>"/>
                </div>
              </div>

              <div class="form-group">
                <label class="col-sm-2 control-label" for="select-privacy"><span data-toggle="tooltip" title="<? echo $text_privacy;?>"><? echo $text_privacy;?></span></label>
                <div class="col-sm-10">
                  <select name="config_privacy" class="form-control" id="select-privacy">
					  <?php foreach ($informations as $information) { ?>
                      <?php if ($information['information_id'] == $config_privacy) { ?>
            ...
            <div class="tab-pane" id="tab-server">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="Если включен режим разработки, то обновление модификаций происходит на фронте.">Режим разработки</span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
