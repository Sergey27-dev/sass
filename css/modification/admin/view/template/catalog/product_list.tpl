...
<!-- CostPrice -->
                ...
                <input type="text" name="filter_cost" value="<?php echo $filter_cost; ?>" placeholder="<?php echo $entry_cost; ?>" id="input-cost" class="form-control" />
              </div>
              <div class="form-group">
<!-- CostPrice end -->
...
<!-- CostPrice -->
                  <td class="text-right"><?php if ($sort == 'p.cost') { ?>
                    <a href="<?php echo $sort_cost; ?>" class="<?php echo strtolower($order); ?>"><?php echo $entry_cost; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_cost; ?>"><?php echo $entry_cost; ?></a>
                    <?php } ?></td>
<!-- CostPrice end -->
