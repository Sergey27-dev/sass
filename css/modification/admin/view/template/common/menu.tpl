...
<li><a href="<?php echo $product_tab; ?>"><?php echo $text_product_tab; ?></a></li>
            ...
            <li><a class="parent"><i class="fa fa-image fa-fw"></i> <span>Галерея</span></a>
            <ul>
            <li><a href="<?php echo $gallery_home; ?>">Обзор</a></li>
            <li><a href="<?php echo $gallery_album; ?>">Фотоальбомы</a></li>
            <li><a href="<?php echo $gallery_video; ?>">Видео</a></li>
            <li><a href="<?php echo $gallery_setting; ?>">Настройки</a></li>
            </ul>
            </li>
