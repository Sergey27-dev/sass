...
class ControllerCommonMenu extends Controller {
	public function index() {
		$this->load->language('common/menu');
            ...
            $data['gallery_home'] = $this->url->link('module/opencart_gallery_manager', 'token=' . $this->session->data['token'], 'SSL');
            $data['gallery_album'] = $this->url->link('opencart_gallery/album', 'token=' . $this->session->data['token'], 'SSL');
            $data['gallery_video'] = $this->url->link('opencart_gallery/video', 'token=' . $this->session->data['token'], 'SSL');
            $data['gallery_setting'] = $this->url->link('opencart_gallery/setting', 'token=' . $this->session->data['token'], 'SSL');
      ...
      if (in_array('complete_seo', $this->model_extension_extension->getInstalled('module'))) {
		...
		$data['text_error_log'] = $this->language->get('text_error_log');
				...
				$data['text_filemanager'] = $this->language->get('text_filemanager');
...
$this->load->language('catalog/tab');
		...
		$data["text_suppler"] = $this->language->get("text_suppler");
		...
		$data['error_log'] = $this->url->link('tool/error_log', 'token=' . $this->session->data['token'], 'SSL');
				...
				$data['filemanager'] = $this->url->link('tool/filemanager', 'token=' . $this->session->data['token'], (version_compare(VERSION, '2.2.0.0') >= 0) ? true : 'SSL');
...
$data["suppler"] = $this->url->link("catalog/suppler", "token=" . $this->session->data["token"], "SSL");
