...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['text_link_soc'] = $this->language->get('text_link_soc');
		$data['text_link_vk'] = $this->language->get('text_link_vk');
		$data['text_link_inst'] = $this->language->get('text_link_inst');
		$data['text_privacy'] = $this->language->get('text_privacy');
		$data['text_yametric'] = $this->language->get('text_yametric');
		$data['text_yawebm'] = $this->language->get('text_yawebm');
		$data['text_googleconsole'] = $this->language->get('text_googleconsole');
		...
		if (isset($this->request->post['config_soc_inst'])) {
			$data['config_soc_inst'] = $this->request->post['config_soc_inst'];
		} else {
	...
	if (isset($this->request->post['config_yametr'])) {
			$data['config_yametr'] = $this->request->post['config_yametr'];
		} else {
			$data['config_yametr'] = $this->config->get('config_yametr');
		}

			if (isset($this->request->post['config_yawebm'])) {
			$data['config_yawebm'] = $this->request->post['config_yawebm'];
		} else {
			$data['config_yawebm'] = $this->config->get('config_yawebm');
		}

			if (isset($this->request->post['config_googleconsole'])) {
			$data['config_googleconsole'] = $this->request->post['config_googleconsole'];
		} else {
			$data['config_googleconsole'] = $this->config->get('config_googleconsole');
		}
