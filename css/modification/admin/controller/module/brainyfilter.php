...
class ControllerModuleBrainyFilter extends Controller {
     ...
     */
    protected $model_module_brainyfilter;
    ...
    public function index()
    {
		...
		$this->_data['footer'] = $this->load->controller('common/footer');
            ...
            $this->_data['seoUrl'] = $this->url->link('module/brainyfilter_seo', 'token=' . $this->session->data['token'], 'SSL');
            $lang = $this->load->language('module/brainyfilter_seo');
            if (!isset($this->_data['lang'])) {
                $this->_data['lang'] = new stdClass();
            }
            $this->_data['lang']->top_menu_seo_urls = $lang['top_menu_seo_urls'];
    ...
    public function removeInstance()
    {
        ...
        if ($moduleId && $moduleId !== 'basic' && $moduleId !== 'new') {
            ...
            if (!isset($settings['brainyfilter_seo'])) {
                $settings['brainyfilter_seo'] = $this->config->get('brainyfilter_seo');
            }
...
//        }
    ...
    {
        if (!isset($this->model_module_brainyfilter)) {
            $this->load->model('module/brainyfilter');
            $this->model_module_brainyfilter = new ModelModuleBrainyFilter($this->registry);
        }
    }
}