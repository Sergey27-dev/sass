...
// CostPrice end
        ...
        if (isset($this->request->post['product_complect'])) {
            $productComplects = $this->request->post['product_complect'];
        } elseif (isset($this->request->get['product_id'])) {
            $productComplects = $this->model_catalog_product->getProductComplect($this->request->get['product_id']);
        } else {
            $productComplects = array();
        }

        $data['product_complects'] = array();

        foreach ($productComplects as $product_id) {
